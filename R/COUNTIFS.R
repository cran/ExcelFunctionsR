...
#' @return In this example we count the amount of cells where Spcies are setosa and has a Petal Width of 0.2 .Function will always return numeric class.


COUNTIFS <-
  function(criteria_range1 , criteria1, criteria_range2 = TRUE ,criteria2 = TRUE,
